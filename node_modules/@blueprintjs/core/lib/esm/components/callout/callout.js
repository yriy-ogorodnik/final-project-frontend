...
var Callout = /** @class */ (function (_super) {
    ...
    Callout.prototype.render = function () {
        ...
        var classes = classNames(Classes.CALLOUT, Classes.intentClass(intent), (_a = {}, _a[Classes.CALLOUT_ICON] = iconElement != null, _a), className);
        return (React.createElement("div", __assign({ className: classes }, htmlProps),
            iconElement,
            title && React.createElement(H5, null, title),
            Utils.isReactNodeEmpty(children) ? undefined : React.createElement("div", { className: Classes.CALLOUT_BODY }, children)));
    };
